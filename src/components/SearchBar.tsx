...
const searchIndex: SearchItem[] = [
  ...
  { label: 'Contact & Feedback', href: '#feedback', icon: '📬', keywords: ['contact', 'feedback', 'suggestion', 'bug', 'report', 'feature request', 'correction', 'email', 'write to us', 'reach us', 'help', 'support', 'complaint'] },
