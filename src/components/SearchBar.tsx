...
const searchIndex: SearchItem[] = [
  ...
  { label: 'Restaurants & Food', href: '#restaurants', icon: '🍽️', keywords: ['food', 'restaurant', 'eat', 'dining', 'lunch', 'dinner', 'chinese', 'north indian', 'pizza', 'burger', 'fast food', 'biryani', 'dine', 'cuisine', 'nandos', 'bercos', 'mamagoto', 'yellow chilli'] },
  { label: 'Cafes & Lounges', href: '#cafes', icon: '☕', keywords: ['cafe', 'coffee', 'chai', 'tea', 'lounge', 'rooftop', 'bar', 'pub', 'starbucks', 'blue tokai', 'chaayos', 'social', 'brewery', 'cocktail', 'hookah', 'nightlife', 'drinks', 'brunch', 'third wave'] },
