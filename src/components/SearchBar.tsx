...
const searchIndex: SearchItem[] = [
  ...
  { label: 'Near Me', href: '#near-me', icon: '🧭', keywords: ['near me', 'nearby', 'parking', 'car park', 'gym near me', 'fitness near', 'petrol pump', 'petrol', 'diesel', 'fuel', 'cng', 'pharmacy', 'medical store', 'chemist', 'medicine', 'drug store', 'dispensary', 'atm', 'bank', 'cash', 'withdraw', 'hdfc', 'sbi', 'icici', 'axis', 'grocery', 'kirana', 'supermarket', 'dmart', 'reliance fresh', 'vegetables', 'auto stand', 'auto', 'cab', 'taxi', 'ola', 'uber', 'rickshaw', 'metro station', 'nearest metro', 'metro near me', 'blue line', 'aqua line', 'dmrc', 'nmrc', 'rapid metro'] },
];
